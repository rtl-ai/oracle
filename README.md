...
| `--browser-agent-mode <on\|off\|current>`                       | Control ChatGPT Agent mode before submitting the prompt. `current` leaves the UI state unchanged; `on` dismisses connector safety prompts by turning connectors off.                                                                                                                                                                      |
